...
export function InfoIcon({ size = 24, classname = "fill-neutral-50" }: icon) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function TimeIcon({ size = 24, classname = "fill-neutral-50" }: icon) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function UserIcon({ size = 24, classname = "fill-neutral-50" }: icon) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
...
export function KeyIcon({ size = 24, classname = "fill-neutral-50" }: icon) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
